...
//        
        ...
        //Fluent wait
        Wait<WebDriver> wait=new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(8))
        		.pollingEvery(Duration.ofSeconds(2)).withMessage("Fluent wait")
        		.ignoring(NoSuchElementException.class);
        ((WebElement) wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//a[@href='https://www.ebay.com/b/Apple/bn_21819543\']")))).click();
